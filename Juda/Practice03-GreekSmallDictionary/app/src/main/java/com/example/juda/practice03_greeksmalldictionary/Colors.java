...
//Your ColorsActivity calls setContentView with R.layout.activity_category that contains a LinearLayout and not a ListView.
// Since you don't have a ListView declared into that layout,
// findViewById(R.id.list) returns null and when you try to
// access it by calling listView.setAdapter(adapter); the NullPointerException is thrown.

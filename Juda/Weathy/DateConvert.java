...
public class DateConvert {
	...
	public static dateConvertToString(Context context, long utcMidnight, boolean fullDate) {
	...
	private static String getDayName(Context context, long dateInMillis) {
		...
		switch (daysAfterToday) {
			case 0:
			return content.getString(R.string.today);
			case 1:
			return content.getString(R.string.tomorrow);
			default:

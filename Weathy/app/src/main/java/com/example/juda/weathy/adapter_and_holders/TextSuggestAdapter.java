...
public class TextSuggestAdapter extends BaseAdapter implements Filterable {
    ...
    private List<JsonObjectList> jsonObject;

    private List<JsonObjectList> suggestions = new ArrayList<>();

    private Filter filter = new CustomFilter();


    public TextSuggestAdapter(Context context, List<JsonObjectList> jsonObject) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holders.textSuggestion = (TextView)convertView.findViewById(R.id.text_completion);
